...
"use strict";$(document).ready(function(){var t=$(".burger__list").bxSlider({pager:!1,controls:!1});$(".burger__control-left").on("click",function(e){e.preventDefault(),t.goToPrevSlide()}),$(".burger__control-right").on("click",function(e){e.preventDefault(),t.goToNextSlide()})}),function(){for(var e=document.querySelectorAll(".btn-rev"),t=document.getElementById("review-pop"),n=document.querySelector(".reviews-pop__close"),i=0;i<e.length;i++){e[i].addEventListener("click",function(e){e.preventDefault(),l()})}function l(){t.classList.toggle("reviews-pop--active")}n.addEventListener("click",function(e){e.preventDefault(),l()})}(),function(e){var t=document.querySelector(e),n=t.firstElementChild,i=document.querySelectorAll(".burger-nav__link"),l=t.lastElementChild;n.addEventListener("click",function(e){e.preventDefault(),r()});for(var c=0;c<i.length;c++){i[c].addEventListener("click",function(){r()})}function r(){t.classList.toggle("burger-menu--active")}l.addEventListener("click",function(){r()})}(".burger-menu"),document.addEventListener("click",function(e){var t=e.target,n=document.querySelector("#menu__list");if(t.classList.contains("menu__link")){e.preventDefault();var i=t.nextElementSibling,l=i.firstElementChild.clientWidth,c=t.parentNode,r=n.children;if(c.classList.contains("menu__item--active"))c.classList.remove("menu__item--active"),i.style.width=0;else{for(var a=0;a<r.length;a++){var o=r[a];o.classList.remove("menu__item--active"),o.lastElementChild.style.width=0}c.classList.add("menu__item--active"),i.style.width=l+"px"}}}),document.addEventListener("click",function(e){var t=e.target,n=document.querySelector("#team__acco");if(t.classList.contains("team__name")){e.preventDefault();var i=t.nextElementSibling,l=i.firstElementChild.clientHeight,c=t.parentNode,r=n.children;if(c.classList.contains("team__item--active"))c.classList.remove("team__item--active"),i.style.height=0;else{for(var a=0;a<r.length;a++){var o=r[a];o.classList.remove("team__item--active"),o.lastElementChild.style.height=0}c.classList.add("team__item--active"),i.style.height=l+"px"}}}),$(void ymaps.ready(function(){for(var e=new ymaps.Map("map",{center:[53.906605232853664,27.584537234374988],zoom:12,controls:[]},{minZoom:10,maxZoom:13}),t=[[53.906605232853664,27.584537234374988],[53.928455840327786,27.50093814379882],[53.87713623431224,27.49673244006348]],n=new ymaps.GeoObjectCollection({},{}),i=0;i<t.length;i++)n.add(new ymaps.Placemark(t[i]));e.geoObjects.add(n)}));
